  ...
  return (
    ...
    <div className={`d-flex flex-row ${styles.AvatarSection}`}>
      ...
      <div className={`${styles.text}`}>
        <h5 className={`${styles.texth5}`}>Laguda Temitayo</h5>
        <p className={`${styles.textp}`}>Chief Manager</p>
      </div>
        ...
        <div className={`d-flex flex-column ${styles.nav}`}>
          ...
          <Link passHref href="/buy_airtime_data" _hover={{ textDecor: "none" }}>
            <div className="d-flex  align-items-baseline flex-column m-4">
              ...
              <a className={`navbarbrand ${styles.link} `}>Buy Airtime and Data</a>
            </div>
          </Link>
          <Link passHref href="/send_money" _hover={{ textDecor: "none" }}>
            <div className="d-flex  align-items-baseline flex-column m-4">
              <div
                style={{
                  marginRight: "12px",
